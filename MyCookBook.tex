...
\prepAndCookTime{10 m}{40 m}
\vegetarianAndServings{3}
\cuisineAndTotalTime{Indian}{50 m}
\begin{ingreds}
	(sunflower) oil
	\quantities{300 grms} paneer
	\quantities{2-3} onions (roughly chooped)
	\quantities{3} tomatos (roughly chooped)
	\quantities{1 tsp} salt 
	\quantities{1/3 cup} cashew nuts 
	ghee 
	\quantities{1 tbsp} garam masala 
	coriander leaves 
	\quantities{50 grms} khoya / condensed milk
	\quantities{3 tbsp} almond milk
	\quantities{1 tbsp} sugar 
	\quantities{3 tbsp} soja cream
	\quantities{1/4 cup} water
	salt
	cumin 
	paprika powder 
	cayenne pepper 
